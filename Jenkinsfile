        ...
        stage('Place configuration files') {
            ...
            steps{
                ...
                script {
					...
					switch (ETE_BRANCH) {
						case ~/DEV/: 
		                    sh "[ -d ${DEV_APPS_HOME1} ] && echo Directory ${DEV_APPS_HOME1} exists."
		                    sh "[ -d ${DEV_APPS_HOME2} ] && echo Directory ${DEV_APPS_HOME2} exists."
		                    sh "[ -d ${DEV_APPS_HOME3} ] && echo Directory ${DEV_APPS_HOME3} exists."
